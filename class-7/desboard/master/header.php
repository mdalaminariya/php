    ...
    <div class="logo">
        ...
        <div class="sidebar-user-switcher user-activity-online">
            <a href="#">
                ...
                <img src="../../profile/image/<?= $user['image'] ?>">
                <?php else :?>
                    <img src="../../profile/profile_pic/<?= $user['picture'] ?>">
                    <?php endif ;?>
    ...
    <div class="app-menu">
        <ul class="accordion-menu">
            ...
            <li class=" <?= ($link == 'profile.php') ? 'active-page' : '' ?>">
                <a href="../profile/profile.php"><i class="material-icons-two-tone">manage_accounts</i>Setting </a>
            </li>
            <li>
