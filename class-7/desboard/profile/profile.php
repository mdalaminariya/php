...
<div class="row">
                ...
                <form action="update.php" method="post">
                    <div class="example-content">
                        ...
                        <div>
                            ...
                            <button type="submit" name="name_btn" class="btn btn-primary my-3"><i class="material-icons">system_update_alt</i>Save</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="card-body">
                <form action="update.php" method="post">
                    <div class="example-content">
                        ...
                        <?php endif; unset($_SESSION["update_email"]); ?>
                        <!-- email_update end -->

                        <div>
                            <button type="submit" name="email_btn" class="btn btn-primary my-3"><i class="material-icons">system_update_alt</i>Save</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="col-6">
        <div class="card" style="overflow-y: scroll; height: 227px;">
            <div class="card-header">
            ...
            <div class="card-body">
                <form action="update.php" method="post">
                    <div class="example-content">
                        ...
                        <?php endif; unset($_SESSION["old_pass_error"]); ?>
                        <!-- old_pass_error end -->
                        ...
                        <?php endif; unset($_SESSION["old_password_update"]); ?>
                        ...
                        <?php endif; unset($_SESSION["new_pass_error"]); ?>
                        <!-- new_pass_error end -->
                        ...
                        <?php endif; unset($_SESSION["new_password_update"]); ?>
                        ...
                        <?php endif; unset($_SESSION["confirm_error"]); ?>
                        <!-- confirm_error end -->
                        ...
                        <?php endif; unset($_SESSION["confirm_update"]); ?>
                        <!-- confirm_update end -->

                        <div>
                            <button type="submit" name="password_btn" class="btn btn-primary my-3"><i class="material-icons">system_update_alt</i>Save</button>
                        </div>
