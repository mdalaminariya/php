        ...
        <div class="app-sidebar">
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <?php if($user['image'] == 'default-profile.jpg'): ?>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?= ($link == 'portfolio.php') ? 'active-page' : '' ?>">
                        <a href="../../dashboard/portfolio/portfolio.php"><i class="material-icons-two-tone">dynamic_form</i>Portfolio</a>
                    </li>
                    <li class="<?= ($link == 'testimonial.php') ? 'active-page' : '' ?>">
                        <a href="../testimonial/testimonial.php"><i class="material-icons-two-tone">tenancy</i>Testimonial</a>
                    </li>
                    <li class="<?= ($link == 'education.php') ? 'active-page' : '' ?>">
                        <a href="../../dashboard/education/education.php"><i class="material-icons-two-tone">school</i>Education</a>
                    </li>
                    <li class="<?= ($link == 'fact.php') ? 'active-page' : '' ?>">
                        <a href="../fact/fact.php"><i class="material-icons-two-tone">precision_manufacturing</i>Fact</a>
                    </li>
                    <li class="<?= ($link == 'sponsor.php') ? 'active-page' : '' ?>">
                        <a href="../sponsor/sponsor.php"><i class="material-icons-two-tone">diversity_2</i>Sponsor</a>
                    </li>
