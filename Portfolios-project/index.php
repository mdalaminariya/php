...
$service_status = "SELECT * FROM services WHERE status = 'active'";
$statuss = mysqli_query($db,$service_status);

$port_query = "SELECT * FROM portfolios WHERE status = 'active'";
$portfolios = mysqli_query($db,$port_query);

$fact_read = "SELECT * FROM facts Where status= 'active'";
$facts = mysqli_query($db,$fact_read);

$sponsor_read = "SELECT * FROM sponsors Where status = 'active'";
$sponsors = mysqli_query($db,$sponsor_read);

$testimonial_read = "SELECT * FROM testimonials Where status = 'active'";
        ...
        <header>
                                ...
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="./Authentication/login.php">Deshboard</a></li>
                                            <?php else: ?>
                                            <li class="nav-item"><a class="nav-link" href="./Authentication/login.php">Loging</a></li>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
            ...
            <div class="extra-info">
                ...
                <div class="social-icon-right mt-20">
                    ...
                    <a href="#"><i class="fab fa-tweter"></i></a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                ...
                                <?php else :?>
                                    <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am Cow</h2>
                                <?php endif;?>
                                ...
                                <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                    <ul>
                                        <li><a target="_blank" href="<?= $link['facebook']?>"><i class="fab fa-facebook"></i></a></li>
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <?php if($user['image'] == 'picture.jpg'): ?>
                                <img src="./public/defult_img/<?= $user['image'] ?>" alt="" style='width: 550px; height: 800px;'>
                                <?php else: ?>
                                    <img src="./public/profile/<?= $user['image'] ?>" alt="" style='width: 550px; height: 800px;'>
                                    <?php endif;?>
                            </div>
                        </div>
                    </div>
                             ...
                             <div class="education">
                                 ...
                                 <div class="location">
                                     ...
                                     <div class="progressWrapper">
                                         <div class="progress">
                                             <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: <?= $education['ratio'] ?>%;" aria-valuenow="<?= $education['ratio'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
                                <div class="speaker-thumb">
                                    <img src="./public/portfolio/<?= $portfolio['image'] ?>" alt="img" style="height: 400px;">
								</div>
								<div class="speaker-overlay">
                                    <span><?= $portfolio['title'] ?></span>
									<h4><a href="portfolio-single.html"><?= $portfolio['sub'] ?></a></h4>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="testimonial-active">
                                ...
                                <div class="single-testimonial text-center">
                                    ...
                                    <img src="./public/Testimonial/<?= $testimonial['image'] ?>" alt="img" style="height: 400px;">
                                    </div>
                                    <div class="testi-content">
                                        <h4><span>“ <?= $testimonial['description'] ?>”</span></h4>
                    ...
                    <div class="row brand-active">
                        ...
                        <div class="col-xl-3">
                            <div class="single-brand">
                                <img src="./public/Sponsors/<?= $sponsor['image'] ?>" alt="img">
                            </div>
                        </div>
                        <?php endforeach;?>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="contact-form">
                                <form action="./dashboard/email/email.php" method="post">
                                    <input name="name" type="text" placeholder="your name *">
                                    <input name="email" type="email" placeholder="your email *" style="text-transform: lowercase;">
                                    <textarea name="body" id="message" placeholder="your message *"></textarea>
                                    <button type="submit" name="email_sender" class="btn">SEND</button>
                                </form>
                            </div>
                        </div>
                    </div>
